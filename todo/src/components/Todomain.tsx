...
export  const Todomain = () => {
  ...
  return (
    ...
    <button type="submit" onClick={addValue} className="bg-gray-500 text-white py-2 px-4 rounded-full">Add</button>
        <ul>
            {todos && todos.map((todo)=>(
                ...
                style={{textDecoration : todo.completed ? "line-through" : "none",cursor:"pointer"}}>
                    ...
                    <button onClick={()=>{todoDelete(todo.id)}} className="bg-red-500 text-white py-2 px-4 rounded-full">Delete</button>
                    </>
                    )
                    }
                </li>
